...
\subsection{Projects utilising Semantic Web}
...
For a given policy $P_c$ representing activities permitted by given consent and policy $P_s$ representing processing activity, compliance is evaluated by checking whether $P_c$ complies with $P_s$ - which in OWL2 is checked by using a reasoner to check whether $P_c \subseteq P_s$

A log is recorded using the Policy Log vocabulary \cite{bonatti_special_2018-1} and is evaluated for compliance 
...
\subsection{Research utilising Semantic Web}
