...
\begin{itemize}
    \item Of the 29 approaches presented as addressing GDPR, 9 are outcomes of a research project. Of these 9 projects, 6 approaches are part of 12 that utilise semantic web, and feature cross-collaboration between their researchers and outputs. Upon collecting collaborations under the umbrella of the parent project, only the 2 projects of SPECIAL and MIREL are notable in utilising semantic web and producing resources used in other approaches and projects. Within the domain of addressing GDPR compliance using semantic web - these are considered as most extensive in terms of published results.
    \item Of the 29 approaches addressing GDPR compliance, only three approaches provide a representation of GDPR, and do so in a machine-readable format.
    \item 20 of the 29 approaches addressing GDPR compliance also model concepts from the GDPR in the form of an ontology or data model. Additionally, all of the 5 approaches involving privacy policies also provide concepts relevant to the GDPR.
