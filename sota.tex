...
An overview of the state of the art from \autoref{sec:sota:gdpr-semweb} and \autoref{sec:sota:gdpr-other} is presented in \autoref{table:sota:analysis:overview}. It shows the diversity in approaches as well as the versatility of technological solutions developed, amongst which is the use of semantic web technologies. In particular, approaches that utilise semantic-web utilise its inherent logic-based formalism to represent the GDPR and associated information using ontologies. 

% TODO: table of existing work
\begin{table}[htbp]
\footnotesize
\centering
\caption{Overview of existing approaches. Column headings: (R): Representation of GDPR, (MG): Modelling of Concepts, (EA): Ex-Ante Compliance, (EP): Ex-Post Compliance, (P): Process Flows, (C): Consent, (Cm): Evaluates Compliance, (Rq): Specifies Requirements}\label{table:sota:analysis:overview}
\begin{tabularx}{\textwidth}{|l|p{27mm}|X|X|X|X|X|X|X|X|}
\hline

\textbf{Work} & \textbf{Formalism} & \textbf{R} & \textbf{M} & \textbf{EA} & \textbf{EP} & \textbf{P} & \textbf{C} &\textbf{Cm} & \textbf{Rq} \\ \hline

SPECIAL & OWL &  &  & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  \\ \hline
SPL+SERAMIS & OWL & \checkmark & \checkmark &  &  &  &  & \checkmark & \checkmark \\ \hline
SPL+Vos et al. & OWL,ASP & \checkmark & \checkmark &  &  &  &  & \checkmark & \checkmark \\ \hline
SPL+CitySPIN & OWL &  & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  \\ \hline
MIREL & OWL,RuleML,BPMN & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  & \checkmark & \checkmark \\ \hline
MRL+DAPRECO & OWL,RuleML,BPMN & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  & \checkmark & \checkmark \\ \hline
BPR4GDPR & OWL &  &  & \checkmark & \checkmark & \checkmark &  & \checkmark & \checkmark \\ \hline
Elluri et al. & OWL &  & \checkmark &  &  &  &  &  &  \\ \hline
Ujcich et al. & OWL &  &  &  & \checkmark & \checkmark &  &  &  \\ \hline
PICS & OWL &  &  &  & \checkmark &  &  &  &  \\ \hline
Geko and Tjoa & OWL &  & \checkmark &  &  &  &  &  &  \\ \hline
LPL &  &  & \checkmark &  &  &  &  &  &  \\ \hline
Lodge et al &  &  & \checkmark &  & \checkmark & \checkmark & \checkmark & \checkmark &  \\ \hline
Peras &  &  & \checkmark &  &  & \checkmark & \checkmark &  &  \\ \hline
Tom et al & BPMN &  & \checkmark & \checkmark &  & \checkmark &  & \checkmark &  \\ \hline
Coletti et al &  &  & \checkmark & \checkmark &  &  & \checkmark &  & \checkmark \\ \hline
Corrales et al &  &  &  &  &  &  &  & \checkmark & \checkmark \\ \hline
LUCE &  &  &  &  &  & \checkmark &  & \checkmark &  \\ \hline
AdvoCATE & OWL &  & \checkmark &  &  &  & \checkmark & \checkmark &  \\ \hline
Singh et al &  &  &  & \checkmark &  & \checkmark &  &  &  \\ \hline
Sion et al & UML,DFD &  & \checkmark & \checkmark &  & \checkmark &  & \checkmark &  \\ \hline
privacyTracker &  &  & \checkmark &  & \checkmark & \checkmark &  & \checkmark & \checkmark \\ \hline
Spagnuelo et al &  &  &  &  &  &  &  &  & \checkmark \\ \hline
Diamantopulou et al &  &  & \checkmark &  &  &  &  &  &  \\ \hline
Robol et al & STS &  & \checkmark & \checkmark &  &  &  & \checkmark &  \\ \hline
GuideMe &  &  &  &  &  &  &  & \checkmark & \checkmark \\ \hline
Basin et al &  &  &  & \checkmark &  & \checkmark &  & \checkmark &  \\ \hline
RestAssured & XACML &  & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  \\ \hline
Fox et al &  &  & \checkmark &  &  &  & \checkmark &  &  \\ \hline
DEFeND &  &  & \checkmark & \checkmark &  & \checkmark &  & \checkmark &  \\ \hline
OPERANDO &  &  &  &  &  &  & \checkmark & \checkmark &  \\ \hline
PDP4E &  &  &  &  &  &  &  &  & \checkmark \\ \hline
PoSEID-on &  &  &  &  &  &  & \checkmark & \checkmark &  \\ \hline
STAR+STAR-II &  &  &  &  &  &  &  &  & \checkmark \\ \hline
MHMD & OWL &  &  &  &  &  & \checkmark &  &  \\ \hline
PAPAYA &  &  &  &  &  &  &  &  &  \\ \hline
SMOOTH &  &  &  &  &  &  &  &  &  \\ \hline
SODA &  &  &  &  &  &  &  & \checkmark &  \\ \hline
DECODE &  &  &  &  &  &  & \checkmark & \checkmark &  \\ \hline
PRIPARE &  &  &  &  &  &  &  &  & \checkmark \\ \hline
Galle et al &  &  & \checkmark &  &  &  &  &  &  \\ \hline
Polisis &  &  & \checkmark &  &  &  &  &  &  \\ \hline
Linden et al &  &  & \checkmark &  &  &  &  &  &  \\ \hline
PrivacyGuide &  &  & \checkmark &  &  &  &  &  &  \\ \hline
Grando et al & XACML &  &  &  &  &  & \checkmark &  &  \\ \hline
Consent Receipt &  &  &  &  &  &  & \checkmark &  &  \\ \hline
...
An analysis of such research projects within the state of the art therefore provides valuable insights into stakeholder requirements and developed solutions.
The research projects are presented in a comparative Table X4 outlining their approaches, formalisms, deliverables, and years of operation. Given that some projects have concluded whereas others are ongoing, the projects also provide insight into further developments within the state of the art in the coming years.
...
\subsection{Identification of Opportunities based on Gaps}
