...
The UsablePrivacy project \cite{sadeh_usable_2013}
use of semantic web technologies \cite{oltramari_privonto:_2018}
Galle et al. \cite{galle_case_2019} argue for a similar corpus of GDPR-specific privacy policies

Polisis \cite{harkous_polisis:_2018}
analysis of privacy policies using taxonomy by Wilson et al. \cite{wilson_creation_2016} depicted in \autoref{fig:sota:Linden-taxonomy}
Further GDPR specific work Analysis of privacy policies post-GDPR \cite{linden_privacy_2018}
collect policies with pre-GDPR and post-GDPR version
use list of the queries derived from ICO’s GDPR checklists to obtain coverage of GDPR
reuse Polisis \cite{harkous_polisis:_2018}
...
PrivacyGuide \cite{tesfay_privacyguide:_2018}
visulisation, dashboard 
concepts: data collection, protection of children, third-party sharing, data security, data retention, data aggregation, control of data, privacy settings, account deletion, privacy breach notification, policy changes.
examples of keywords occuring in policies for each concept
...
Grando et al. \cite{grando_ontological_2012} ontology-based model of subject’s permissions and organization’s obligations resulting from the informed consent process
XACML for rules implementing consent management system
...
Consent receipt specification \cite{lizar_consent_2017}

A study of consent through LinkedIn settings \cite{v_consent_2019}
