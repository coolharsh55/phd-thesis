...
\subsubsection{Methodology for Analysis}
Analysis of the state of the art is based on assessing the approaches undertaken to address GDPR and its compliance requirements. The surveys presented in \autoref{sec:sota:models} regarding classification of approaches regarding legal compliance \cite{otto_addressing_2007} and phases of compliance \cite{fellmann_state---art_2014} provide a criteria to classify the approaches. In addition, the information disseminated by authoritative bodies, presented in \autoref{sec:background:GDPR}, provides an investigative framework to analyse information regarding GDPR compliance.
The analysis of the state of the art utilises a set of questions derived from these, and summarised as follows:
\begin{enumerate}
    ...
    \item What are the formalism used in the approach?
...
\subsection{Overview of existing work}
\subsubsection{European Research Projects}
The state of the art consists of a significant number of European research projects which directly or indirectly incorporate GDPR compliance as an objective. These projects represent dedicated resources in terms of funding and personnel, as well as collaboration between universities, research institutes, and the industry - which often also includes participation of legal experts and legal organisations.
...
To facilitate this, the research projects are presented in a comparative Table X4 outlining their approaches, formalisms, deliverables, and years of operation.
% TODO: Table table of EU research projects

% \subsection{Articles of GDPR addressed}

\subsection{Formalism used}
...
\subsection{Modelling of process flows}\label{sota:analysis:process-flows}
...
\subsection{Representation of Process Flows}
