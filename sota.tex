...
Analysis of the state of the art is based on assessing the approaches undertaken to address GDPR and its compliance requirements. 
In its analysis, particular emphasis is placed on those that utilise semantic web (\autoref{sec:sota:gdpr-semweb}) based on the motivation of the thesis and its research question (\autoref{sec:intro:background}), with the other approaches described in \autoref{sec:sota:gdpr-other}.
...
For ease of reference, the following labels are used to indicate their respective work within the state of the art.
% TODO: table of labels and citations of work
% label, references, presented in Section X

\subsubsection{Overview}
An overview of the state of the art from \autoref{sec:sota:gdpr-semweb} and \autoref{sec:sota:gdpr-other} is presented in \autoref{table:sota:analysis:overview}. The column headings represent the following - (T): type of work where P is project and R is research publication, (R): Representation of GDPR, (MG): Modelling of Concepts, (EA): Ex-Ante Compliance, (EP): Ex-Post Compliance, (P): Process Flows, (C): Consent, (Cm): Evaluates Compliance, (Rq): Specifies Requirements, (O): open \& accessible resources. It shows the diversity in approaches as well as the versatility of technological solutions developed, amongst which is the use of semantic web technologies. In particular, approaches that utilise semantic-web utilise its inherent logic-based formalism to represent the GDPR and associated information using ontologies. 
...
SPECIAL & P &  & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark &  & \cmark \\ \hline
SPL+SERAMIS & P & \cmark & \cmark &  &  &  &  & \cmark & \cmark &  \\ \hline
SPL+Vos et al & R &  & \cmark &  &  &  &  & \cmark & \cmark & \cmark \\ \hline
SPL+CitySPIN & P &  & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark &  & \cmark \\ \hline
MIREL & P & \cmark & \cmark & \cmark & \cmark & \cmark &  & \cmark & \cmark &  \\ \hline
MRL+DAPRECO & P & \cmark & \cmark & \cmark & \cmark & \cmark &  & \cmark & \cmark &  \\ \hline
BPR4GDPR & P &  &  & \cmark & \cmark & \cmark &  & \cmark & \cmark &  \\ \hline
Elluri et al. & R &  & \cmark &  &  &  &  &  &  & \cmark \\ \hline
Ujcich et al. & R &  & \cmark &  & \cmark & \cmark &  &  &  &  \\ \hline
PICS & R &  &  &  & \cmark &  &  &  &  &  \\ \hline
Geko and Tjoa & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
LPL & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
Lodge et al & R &  & \cmark &  & \cmark & \cmark & \cmark & \cmark &  &  \\ \hline
Peras & R &  & \cmark &  &  &  & \cmark &  &  &  \\ \hline
Tom et al & R &  & \cmark & \cmark &  & \cmark &  & \cmark &  &  \\ \hline
Coletti et al & R &  & \cmark & \cmark &  &  & \cmark &  & \cmark &  \\ \hline
Corrales et al & R &  &  &  &  &  &  & \cmark & \cmark &  \\ \hline
LUCE & R &  &  &  &  & \cmark &  & \cmark &  &  \\ \hline
AdvoCATE & R &  & \cmark &  &  &  & \cmark & \cmark &  &  \\ \hline
Singh et al & R &  &  & \cmark &  &  &  &  &  &  \\ \hline
Sion et al & R &  & \cmark & \cmark &  & \cmark &  & \cmark &  &  \\ \hline
privacyTracker & R &  & \cmark &  & \cmark & \cmark &  & \cmark & \cmark &  \\ \hline
Spagnuelo et al & R &  &  &  &  &  &  &  & \cmark &  \\ \hline
Diamantopulou et al & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
Robol et al & R &  & \cmark & \cmark &  &  &  & \cmark &  &  \\ \hline
GuideMe & R &  &  &  &  &  &  & \cmark & \cmark &  \\ \hline
Basin et al & R &  &  & \cmark &  & \cmark &  & \cmark &  &  \\ \hline
RestAssured & P &  & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark &  &  \\ \hline
Fox et al & R &  &  &  &  &  &  &  & \cmark &  \\ \hline
DEFeND & P &  & \cmark & \cmark &  &  &  & \cmark &  &  \\ \hline
OPERANDO & P &  &  &  &  &  & \cmark & \cmark &  &  \\ \hline
PDP4E & P &  &  &  &  &  &  &  & \cmark &  \\ \hline
PoSEID-on & P &  &  &  &  &  & \cmark & \cmark &  &  \\ \hline
STAR+STAR-II & P &  &  &  &  &  &  &  & \cmark & \cmark \\ \hline
MHMD & P &  &  &  &  &  & \cmark &  &  &  \\ \hline
PAPAYA & P &  &  &  &  &  &  &  &  &  \\ \hline
SMOOTH & P &  &  &  &  &  &  &  &  &  \\ \hline
SODA & P &  &  &  &  &  &  & \cmark &  &  \\ \hline
DECODE & P &  &  &  &  &  & \cmark & \cmark &  &  \\ \hline
PRIPARE & P &  &  &  &  &  &  &  & \cmark &  \\ \hline
Galle et al & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
Polisis & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
Linden et al & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
PrivacyGuide & R &  & \cmark &  &  &  &  &  &  &  \\ \hline
Consent Receipt &  &  &  &  &  &  & \cmark &  &  & \cmark \\ \hline
...
% \subsection{Articles of GDPR addressed}

\subsubsection{Formalism used}
...
\end{tabular}
\end{table}
1> machine-readable representation of GDPR

2> glossary of concepts and terms associated with GDPR

\subsubsection{Modelling of process flows}\label{sota:analysis:process-flows}
1> representations: semantic-web, BPMN
2> in semantic-web, PROV-O as the standard --> tension between PROV implying provenance, whereas ex-ante compliance models things to happen
SPECIAL logs ex-ante compliance checks using PROV-O

Column headings are as follows - (Repr): representation of process flow, (EA): Ex-ante modelling, (EP): Ex-post modelling, (Pu): Purpose, (Pr): Processing, (DS): Data Sharing, (Rp): Recipients, (St): Data Storage, (Rg): Rights, (LB): Legal Basis.

\subsubsection{Representation of Process Flows}
\begin{table}[htbp]
\footnotesize
\centering
...
\footnotesize
\centering
\caption{Compliance evaluation in SotA}\label{table:sota:analysis:overview}
...
RestAssured & \cmarkACML & Process Flows & \cmark & \cmark & \cmark &  &  \\ \hline
