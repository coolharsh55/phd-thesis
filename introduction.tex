...
Compared to the state of the art, the approach provides a novel utilisation of SHACL in the domain of GDPR compliance, as well as in its use of linking tests and results with the GDPR. Furthermore, the approach is also novel in the utilisation of ex-ante and ex-post validation for GDPR compliance.
A similar use of SHACL utilising P-Plan workflows to validate policies expressed in ODRL for GDPR compliance has been proposed \cite{lieber_policy-compliant_2019}, and demonstrates the further applicability of the contributions of this thesis. 
