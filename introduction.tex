...
\begin{verbatim}
% state of the art
- sota in what domains? how was sota gathered?
1> legal information
- official text of the GDPR, is interpretation and guidance from sources
- case law as it arose - give examples of cases, expert opinions
- compliance guidance issued by sources
2> research
- legal models for compliance other than GDPR
-- what were the legal models identified?
-- role of semantic web in legal models for compliance
- in-depth review of approaches related to GDPR
-- academic: semantic web and non-semantic web, semantic web had projects SPECIAL and MIREL, DAPRECO
-- commercial: details not available, focus on understanding capabilities and tooling offered

% construction of ontologies
- methodologies followed - NEON, ontology 101; lack of involvement from legal experts; compare with SPECIAL methodology and MIREL methodology
- effect methodology for thesis:
1> gather questions related to information associated with GDPR compliance (With a particular focus on activities related to personal data and consent - use them as competency questions - RO1, RO2
2> identify concepts and relationships required to answer these
3> construct preliminary ontology using OWL2 - RO3
4> assess effectiveness of ontology in answering questions, identify changes required
5> repeat steps 1-4 for progressive improvement

% querying and validation framework
1> gather compliance questions - linked to GDPR
2> express compliance questions using SPARQL reusing concepts from developed ontologies to create 'compliance queries' which can be executed over RDF - RO4
3> identify constraints and assumptions from questions
4> express constraints using SHACL - preserve links to GDPR
5> persist validation report for evaluation and query based on methodology (SEMANTiCS poster) - RO5

% evaluation strategy
%% ontologies
- design: best practices in terms of ontology design - OOPS!, WIDOCO
- quality: publishing best practices advocated by community - WIDOCO (metadata, documentation), w3id, zenodo (DOI), SPARQL endpoint
- sufficiency: assess whether concepts and relationships are sufficient to answer competency questions
- comparison against similar ontologies identified in sota
%% querying and validation framework
- evaluate ex-ante and ex-post methods for constraint validation
- compare verbosity of ex-ante vs ex-post e.g. more tests needed to be run
- assess whether framework is capable of retrieving information based on GDPR concepts and clauses e.g. validation information for specific article
\end{verbatim}
