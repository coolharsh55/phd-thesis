...
Finally, the ontology was compared against similar ontologies identified in the SotA to analyse its strengths and weaknesses.

\subsubsection{Evaluating Information Validation Framework}
%% querying and validation framework
The framework developed for validating information for compliance was based on identified constraints from compliance questions.
The framework was evaluated based on applicability to express these constraints using SHACL over data defined using the developed ontologies of GDPRtEXT, GDProv, and GConsent.
The ex-ante and
