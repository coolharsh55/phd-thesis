...
\begin{center}
\footnotesize  \label{table:sparql:dpc-1}
\begin{tabularx}{\textwidth}{|l|l|X|l|}
\caption{Questions provided in the GDPR Readiness Guide} \\
\toprule
\textbf{ID} & \textbf{Category} & \textbf{Title} & \textbf{GDPR} \\ \hline
\endhead
...
\begin{center}
\footnotesize \label{table:sparql:dpc-2}
\begin{tabularx}{\textwidth}{|l|l|X|l|l|l|l|}
\caption{Analysis of compliance questions specified in \autoref{table:sparql:dpc-1}} \\
\toprule
\textbf{ID} & \textbf{Type} & \textbf{Data} & \textbf{E/A} & \textbf{E/P} & \textbf{SPARQL} & \textbf{GDPRov} \\ \hline
\endhead
...
\caption{Validation report with results and link to GDPR}
\label{table:shacl:sparql-report} \\
\hline
\textbf{Name} & \textbf{Type} & \textbf{GDPR} & \textbf{Result} & \textbf{Node} \\ \hline
\endhead
