...
The section concludes with a discussion on the approach and its potential usefulness in the compliance process in \autoref{sec:testing:shacl:eval}.
...
The consent dialogue, depicted in X
...
\subsubsection{Representing Consent Choices using GConsent}
