...
Evaluation was carried out by analysing the extent of ontologies to represent information that answered the collected competency questions. This was carried out in an iterative manner where the ontology was first developed and evaluated, and then the results of evaluation were used as feedback to further develop the ontology. Following the evaluation, changes to the ontology were made based on missing concepts and relationships, or incorrect assumptions expressed in existing ones. Outcomes of this process are presented in the evaluation section of each ontology.
...
\begin{enumerate}
    ...
    \item \textbf{Evaluate:} The ontology was evaluated for sufficiency towards representing information for answering competency questions. The use of a semantic reasoner detected logical inconcistensies in the expressed facts and axioms, while OOPS! provided detection of common pitfalls and bad design patterns.
...
Instead of representing all required information in a single large ontology, modular ontologies provide better reuse and are easier to engineer.
...
GDPRtEXT, and the work described in this section, was published in the resource track at Extended Semantic Web Conference \cite{pandit_gdprtext_2018}. The publication described the creation of the resource, summarised its contents, and also provided mapping of DPD obligations with GDPR using a linked data approach and XACML to denote which obligations from DPD could be re-used towards GDPR compliance. 
% Through this, the research and developed resources were peer-reviewed and adopted.
A survey of legal approaches within the state of the art \cite{leone_taking_2019} included GDPRtEXT as one of the resources surveyed and demonstrates that GDPRtEXT is unique in its provision of GDPR as a machine-readable resource.
...
While the compliance questions provide a basis for identifying information to be modelled, the requirements of expressing this information in ex-ante and ex-post phase enable specifying their intended usage in planning and processing stages respectively, which further determines whether the compliance evaluation consists of verification of a plan or analysis of processing logs. 
The requirements for representing processes can be summarised with the following points:
\begin{enumerate}
...
GConsent also received input through a semi-formal consultation with a law professor at Trinity College Dublin who served as a legal domain expert to validate the compliance questions and the information required to answer them.
GConsent also received input through informal consultations which provided requirements and evaluated its design based on real-world use-cases for a (confidential) research project at MasterCard.
