...
Through these, it can be concluded that GConsent satisfies the requirements of providing information for answering the compliance questions and thus fulfils research objective $RO3(c)$.
\begin{table}[htbp]
\footnotesize
\centering
...
\textit{CMQ57} & Is the purpose or processing associated with a third party? & \textit{Association, ThirdParty} & \textit{hasAssociation, prov:agent} \\ \hline
