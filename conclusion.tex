...
The ontologies were documented using the WIDOCO tool \cite{garijo_widoco_2017}, utilised persistent identifiers provided by W3ID in namespaces, and were published under an open license in the public repository at Zenodo with DOIs.
