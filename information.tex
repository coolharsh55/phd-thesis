...
\hl{
This chapter therefore first presents the analysis of GDPR in terms of stakeholders and interoperability of information between them to construct a model of information interoperability in \autoref{sec:info:model}.
...
This provides an overview of information requirements which can be used to find additional applications for existing information representation approaches and to identify gaps which can be addressed through future opportunities.
Such analyses and requirements gathering related to the GDPR also benefit the larger community and domain by providing the background for standardisation activities in understanding the role of information and its interoperability between stakeholders, such as those for DPVCG \autoref{sec:intro:dpvcg}.
}
...
The \autoref{fig:info:interoperability-model} visualises and consists of Data Subject (DS), Data Controller (DC), Data Processor (DP) and Supervisory Authority\footnote{Supervisory Authority are also referred to as Data Protection Commission or Regulatory Body} (SA) - which are entities defined within the GDPR. 
...
The interactions are considered direction-less, and use the abbreviations defined above. For example, DC-DP represents an interaction between a data controller and a data processor.
...
The analyses of information flows between entities provided the categories of requirements as: provenance records, consent information, data processing agreements, compliance information, and seals/certifications - which are described in brief in the following sections.
\hl{
Carrying out further investigation and analyses of the information communicated in an interaction is out of scope for the research presented in this thesis given the focus of the research question on information about activities associated with processing of personal data and consent. To this end, only the interactions associated with personal data and consent are taken to be within scope, and from which the investigation of information required for compliance is carried out in \autoref{sec:info:compliance-questions}.
}
...
\subsubsection*{Motivation to adopt interoperability as a requirement}
\hl{The model and analyses of information flows between entities provides the motivation for establishing interoperability in the representation of information to be exchanged.
...
\hl{Representing provenance is not limited to representation of processing of personal data, but is also applicable to information about other categories - consent, data processing agreements, compliance, and certifications. Therefore, utilising the same or compatible representation in representing provenance for all categories has advantages of utilising a cohesive management of all associated information towards compliance - and provides an objective for future work in expanding the contributions presented in this thesis.}

With this motivation, the next parts of this chapter provide the requirements gathered for representing information regarding processing of personal data and consent, while also including other relevant information - such as data breaches and provision of rights - to indicate the potential applicability and reuse of developed ontologies in representing \hl{information through provenance records} for GDPR compliance.
...
\hl{The questions were created by studying authoritative sources regarding GDPR compliance  consisting of data protection commissions, legal experts and agencies - that have published guidelines and resources to assist organisations with the process of establishing and maintaining GDPR compliance.
...
\hl{The author of the thesis was part of an informal consulation on a real-world (confidential) research project at MasterCard regarding creation of a semantic web ontology for expressing consent information based on requirements of the GDPR.
The consulation consisted of identifying the information about consent based on requirements of GDPR and designing an ontology to represent it. 
...
\hl{An overview of the assumptions and constraints based on the categories of compliance questions is as follows:}
\begin{itemize}
