...
% TODO: upload all documents to Zenodo and put link here.

The list of questions is presented in \autoref{sec:info:compliance-questions-list} with the assumptions and constraints presented in \autoref{sec:info:constraints}. Along with compliance questions regarding activities associated with processing of personal data and consent, the list also contains questions about additional activities associated with right to be informed and reporting of data breach by controllers. These are provided so as to demonstrate the application of a common approach to represent activities related to GDPR compliance. 
...
With the information identified using the compliance questions, assumptions, and constraints in \autoref{sec:info:compliance-questions}, the creation of ontological representations utilised the well established method of competency questions for ontology engineering \cite{noy,neon}.
The ontological representations of information associated with GDPR were categorised into the following three distinct but related ontologies based on their aim and intended function, as outlined within $RO3$ in \autoref{sec:intro:RO}:
\begin{enumerate}
